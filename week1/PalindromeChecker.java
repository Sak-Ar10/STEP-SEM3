public class PalindromeChecker {
    ...
    public static void main(String[] args) {
        String[] testStrings = {"madam", "hello"};
        ...
        for (String text : testStrings) {
            ...
            String iterStatus = iterResult ? "Palindrome" : "Not Palindrome";
            String recStatus = recResult ? "Palindrome" : "Not Palindrome";
            String arrStatus = arrResult ? "Palindrome" : "Not Palindrome";
            
            System.out.printf("\"%s\"\n", text);
            System.out.printf(" | Iterative: %s | Recursive: %s | Array Reversal: %s\n\n", 
                              iterStatus, recStatus, arrStatus);
        }
    }
}